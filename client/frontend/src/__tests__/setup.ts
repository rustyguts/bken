...
const defaultConfig = {
  ...
  servers: [{ name: 'Local Dev', addr: 'localhost:8443' }],
...
const goApp: Record<string, any> = {
  ...
  SetVAD: vi.fn().mockResolvedValue(undefined),
  SetVADThreshold: vi.fn().mockResolvedValue(undefined),
  SetNoiseGate: vi.fn().mockResolvedValue(undefined),
  SetNoiseGateThreshold: vi.fn().mockResolvedValue(undefined),
