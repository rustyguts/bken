...
CLI_BIN = os.environ.get("VIDPIPE_CLAUDE_CLI", "claude")
...
# wall time). Override to "haiku" or a pinned ID via `VIDPIPE_CLAUDE_MODEL`.
MODEL_FLAG = os.environ.get("VIDPIPE_CLAUDE_MODEL", "sonnet")
