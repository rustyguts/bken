...
CLIP_VIDEO_CODEC = os.environ.get("BKEN_CLIP_VCODEC", "libsvtav1")
CLIP_VIDEO_CRF = int(os.environ.get("BKEN_CLIP_CRF", "28"))
CLIP_VIDEO_PRESET = os.environ.get("BKEN_CLIP_PRESET", "5")
CLIP_AUDIO_BITRATE = os.environ.get("BKEN_CLIP_ABITRATE", "192k")
# Fallback bitrate for codecs that don't expose CRF (libopenh264). 1080p target.
CLIP_VIDEO_BITRATE = os.environ.get("BKEN_CLIP_VBITRATE", "10M")

# Vision (Florence-2) sampling
VISION_FPS = float(os.environ.get("BKEN_VISION_FPS", "1.0"))
VISION_SCENE_DETECT = os.environ.get("BKEN_VISION_SCENE", "1") == "1"
VISION_SCENE_THRESHOLD = float(os.environ.get("BKEN_VISION_SCENE_THRESH", "27.0"))
VISION_MAX_FRAMES = int(os.environ.get("BKEN_VISION_MAX_FRAMES", "5000"))
VISION_BATCH_SIZE = int(os.environ.get("BKEN_VISION_BATCH", "4"))
VISION_SCORE_ENABLED = os.environ.get("BKEN_VISION_SCORE", "1") == "1"
