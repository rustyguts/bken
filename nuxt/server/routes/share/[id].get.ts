...
function baseUrl(event: any): string {
  const envBase = process.env.VIDPIPE_BASE_URL
...
<head>
  ...
  <title>${escapeHtml(title)} — vidpipe</title>
  ...
  <meta property="og:site_name" content="vidpipe">
...
<body>
  ...
  <footer>
    Shared with <a href="/">vidpipe</a> — clip archive
  </footer>
